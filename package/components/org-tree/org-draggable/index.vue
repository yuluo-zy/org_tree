...
<!--<script>-->
<!--import {matchesSelectorToParentElements, getComputedSize, addEvent, removeEvent} from 'package/utils/dom';-->
<!--import {restrictToBounds, snapToGrid} from 'package/utils/fns';-->
